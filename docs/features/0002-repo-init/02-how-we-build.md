...
2. вычисляет пути versioned project contract layer
3. создает недостающие каталоги
4. создает стартовые project-local файлы из встроенных шаблонов
5. печатает оператору, что было создано, а что уже существовало
