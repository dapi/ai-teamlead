...
Для `issue-analysis-flow` нужно было сделать session binding достаточно durable,
не превращая GitHub comments в основной канал общения.
